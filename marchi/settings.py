"""
Django settings for marchi project.
...
ALLOWED_HOSTS = [
    'marchi-course-env.eba-dkgsq9r7.us-west-2.elasticbeanstalk.com',
    'localhost',
]
...
WSGI_APPLICATION = 'marchi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / config('DATABASES_NAME'),
    }
}
